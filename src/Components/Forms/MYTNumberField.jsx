...
function MYTNumberField({required, type, sideInput, sideInputType, sideInputValue, formLabel, size, placeholder}) {
  return (
    <Form>
        {type==="inline" ?
                ...
                <Row>
                    ...
                    <Col sm={6}>
                        <InputGroup size={size} className="mb-3">
                            ...
                            <Form.Control type="number" placeholder={placeholder} size={size}/>

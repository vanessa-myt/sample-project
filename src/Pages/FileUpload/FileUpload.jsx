  ...
  return (
    <div className="page">
      ...
      <div className={`container ${inactive ? "inactive" : "active"}`}>
        ...
        <Row>
          <label className="text-label left mb-4">
            Convert to base64 pdf type
          </label>
        ...
        <Row>
          ...
          <Row>
            <label className="text-label left mb-4">
              Convert to array and show data
            </label>
            <Col xs="5" className="left">
              <input
                type={"file"}
            ...
            <Col xs="2" className="left mb-4">
              <button className="upload-btn" onClick={handleOnSubmit}>
                UPLOAD
              </button>
            </Col>
            <Row>
